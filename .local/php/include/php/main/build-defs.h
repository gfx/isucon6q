...
#define CONFIGURE_COMMAND " './configure'  '--with-config-file-path=/home/isucon/.local/php/etc' '--with-config-file-scan-dir=/home/isucon/.local/php/etc/conf.d' '--prefix=/home/isucon/.local/php' '--libexecdir=/home/isucon/.local/php/libexec' '--without-pear' '--with-gd' '--with-jpeg-dir=/usr' '--with-png-dir=/usr' '--enable-exif' '--with-zlib-dir=/usr' '--with-kerberos' '--with-mcrypt=/usr' '--enable-soap' '--enable-xmlreader' '--with-xsl' '--enable-ftp' '--enable-cgi' '--with-curl=/usr' '--with-tidy' '--with-xmlrpc' '--with-mysql=mysqlnd' '--with-pdo-sqlite' '--with-readline' '--disable-debug' '--enable-phar' '--with-zlib' '--enable-fpm' '--enable-pdo' '--with-mysqli=mysqlnd' '--with-pdo-mysql=mysqlnd' '--with-openssl' '--with-pcre-regex' '--with-pcre-dir' '--with-libxml-dir' '--enable-opcache' '--enable-bcmath' '--with-bz2' '--enable-calendar' '--enable-cli' '--enable-shmop' '--enable-sysvsem' '--enable-sysvshm' '--enable-sysvmsg' '--enable-mbregex' '--enable-mbstring' '--with-mcrypt' '--enable-pcntl' '--enable-sockets' '--with-curl' '--enable-zip' '--with-pear' '--with-libdir=lib64'"
...
#define PHP_EXTENSION_DIR       "/home/isucon/.local/php/lib/php/extensions/no-debug-non-zts-20151012"
